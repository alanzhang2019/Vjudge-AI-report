# v3.9.52 - 部署脚本 v2 (use Python for tar)
...
Write-Host "[$(Get-Date -Format 'HH:mm:ss')] Step 3/5: create tar.gz via Python"
# Use Python to create the tarball (most reliable on Windows)
$pythonCmd = @"
